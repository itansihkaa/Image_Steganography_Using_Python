...
#save
def save():
    secret.save("E:/Python Prog/Stegano/hidden.png")

#icon
image_icon=PhotoImage(file="E:\Python Prog\Steganography/logo.jpg")
root.iconphoto(False,image_icon)

#logo
logo=PhotoImage(file="E:\Python Prog\Steganography/logo.png")
